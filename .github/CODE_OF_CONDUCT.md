...
When an incident does occur, it is important to report it promptly. To report a possible violation, **please contact us on our official email.**
...
4. **Permanent Ban**
  ...
  - **Consequence:** Access to all community spaces, tools, and communication channels is removed. In general, permanent bans should rarely be used, should have strong reasoning behind them, and should only be resorted to if working through other remedies has failed to change the behavior.
...
- This Code of Conduct applies to all **FireHub core, adapters, modules, templates, and organizational repositories**.
- For internal/private discussions (e.g., `.github-private`), additional internal guidelines may apply.
- Contact us on our official email for questions, clarifications, or incident reports.